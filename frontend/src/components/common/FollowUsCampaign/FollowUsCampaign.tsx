...
const FollowUsCampaign: FC = () => {
  ...
  useEffect(() => {
    if (isFollowActive) {
      const embedCode =
        '<a class="e-widget no-button generic-loader" href="/" rel="nofollow">sKrapy NFT Whitelist</a><script type="text/javascript" src="https://widget.gleamjs.io/e.js" async="true"></script>';
      setTimeout(() => {
