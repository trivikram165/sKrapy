            ...
            <div className={s.formWrapper}>
                ...
                <form onSubmit={handleSubmit} className={s.form}>
                     <div className={s.inputGroup}>
                        ...
                        <div className={s.radioGroup}>
                            <label>
                                <input type="radio" value="user" checked={accountType === "user"} onChange={() => setAccountType("user")} disabled={loading} />
                                User
                            </label>
                            <label>
                                <input type="radio" value="vendor" checked={accountType === "vendor"} onChange={() => setAccountType("vendor")} disabled={loading} />
                                Vendor
                            </label>
                        </div>
                    </div>
                ...
                <p className={s.linkText}>
                 ...
                 <p className={s.linkText}>
                    ...
                    <Link href="/forgot-password"><a className={s.link}>Reset Password</a></Link>
                </p>
            </div>
        </div>
    );
